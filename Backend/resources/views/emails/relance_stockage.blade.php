                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #566573; font-size: 15px; line-height: 1.6; margin-bottom: 30px;">
                                Nous vous informons que les articles de votre commande <strong style="color: #0f2a4a;">#{{ $commande->id_commande }}</strong> (réglée le {{ \Carbon\Carbon::parse($commande->date_paiement)->format('d/m/Y') }}) sont prêts et mis à votre disposition dans notre entrepôt central.
                            </p>
